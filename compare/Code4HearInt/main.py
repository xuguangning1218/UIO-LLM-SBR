...
import datetime
import argparse
from model import trans_to_cuda, HearInt, forward
from utils import renumberItems, split_validation, frequencyAdj, Data, get_recall, get_mrr
import torch
...
neighbors = pickle.load(open(opt.path + opt.dataset +'/adj_12' + '.pkl', 'rb'))  # [1:]  # 去掉item0
nums = pickle.load(open(opt.path + opt.dataset +'/num_12' + '.pkl', 'rb'))  # [1:]
