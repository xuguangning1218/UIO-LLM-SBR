...
seq = pickle.load(open('/home/guangxu/work/UIO-SBR/datasets/' + dataset + '/all_train_seq.txt', 'rb'))
...
if dataset == 'diginetica':
    ...
    num = 60417
elif dataset == "retailRocket_DSAN":
    num = 36969
else:
    num = 3
...
pickle.dump(adj, open('/home/guangxu/work/UIO-SBR/datasets/' + dataset + '/adj_' + str(sample_num) + '.pkl', 'wb'))
pickle.dump(weight, open('/home/guangxu/work/UIO-SBR/datasets/' + dataset + '/num_' + str(sample_num) + '.pkl', 'wb'))