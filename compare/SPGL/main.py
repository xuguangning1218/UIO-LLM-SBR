...
def main():
    ...
    train_data = pickle.load(open('/data/UIO-SBR/datasets/' + opt.dataset + '/train.txt', 'rb'))
    test_data = pickle.load(open('/data/UIO-SBR/datasets/' + opt.dataset + '/test.txt', 'rb'))
    all_train = pickle.load(open('/data/UIO-SBR/datasets/' + opt.dataset + '/all_train_seq.txt', 'rb'))
